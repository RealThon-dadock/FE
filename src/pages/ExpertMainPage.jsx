  ...
  const oneWordCards = [
    {
      ...
      color: '#4ECDC4',
      title: '고양이님의 고민',
      subtitle: '심리적 압박감이 심해요',
      content: '안녕하세요, 고양이입니다. 요즘 심리적 압박감이 너무 심해서 어떻게 해야 할지 모르겠어요. 회사에서 일이 많고, 집에서도 여러 가지 일들이 겹치면서 마음이 복잡해요. 특히 밤에 잠을 잘 못 자고, 아침에 일어나기도 힘들어요. 이런 상황을 어떻게 해결해야 할지 조언을 구하고 싶어요.'
    },
    {
      id: 2,
      status: '채택 전',
      ...
      color: '#FF6B6B',
      title: '강아지님의 고민',
      subtitle: '스트레스가 너무 많아요',
      content: '안녕하세요, 강아지입니다. 요즘 스트레스가 너무 많아서 어떻게 해야 할지 모르겠어요. 일도 많고, 개인적인 문제도 있어서 마음이 복잡해요. 특히 사람들과의 관계에서도 어려움을 겪고 있어요. 스트레스를 어떻게 관리해야 할지 조언을 구하고 싶어요.'
    },
    {
      id: 3,
      status: '채택 전',
      ...
      color: '#45B7D1',
      title: '토끼님의 고민',
      subtitle: '불안감이 계속 들어요',
      content: '안녕하세요, 토끼입니다. 요즘 불안감이 계속 들어서 어떻게 해야 할지 모르겠어요. 미래에 대한 걱정이 많고, 현재 상황에 대해서도 불안해요. 특히 중요한 결정을 내려야 할 때마다 더욱 그렇습니다. 이런 불안감을 어떻게 해결해야 할지 조언을 구하고 싶어요.'
    }
  ];
  ...
  const todayBooks = [
    {
      ...
      color: '#E3F2FD',
      content: '안녕하세요, 고냥이입니다. 요즘 회사에서 일이 너무 많아서 스트레스가 심해요. 특히 상사님께서 항상 까다롭게 구시고, 동료들과도 소통이 잘 안 돼요. 매일 밤늦게까지 일하고 집에 가면 너무 지쳐서 아무것도 할 수 없어요. 이런 상황을 어떻게 해결해야 할지 모르겠어요. 심리상담사 너구리 님께서 조언을 해주셔서 이제 조금씩 나아지고 있어요.'
    },
    {
      id: 2,
      title: '멍멍이님의 고민',
      ...
      color: '#E8F5E8',
      content: '안녕하세요, 멍멍이입니다. 저는 사람들과 대화할 때 항상 긴장하고 어색해요. 특히 처음 만나는 사람 앞에서는 말을 제대로 못하고, 대화가 자연스럽게 이어지지 않아요. 친구들도 제가 너무 수줍어한다고 하는데, 어떻게 하면 더 자연스럽게 대화할 수 있을까요? 소통의 기술을 배우면서 조금씩 나아지고 있어요.'
    },
    {
      id: 3,
      title: '토끼님의 고민',
      ...
      color: '#FFF3E0',
      content: '안녕하세요, 토끼입니다. 저는 항상 자신이 없어요. 뭔가를 해도 잘할 수 있을까 하는 생각이 먼저 들고, 실패할까봐 두려워서 도전을 못해요. 특히 중요한 일이나 새로운 일을 할 때는 더욱 그렇습니다. 어떻게 하면 자신감을 가질 수 있을까요? 자기계발을 통해 새로운 변화를 시작하고 있어요.'
    }
  ];
